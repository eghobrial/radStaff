...
class FacultyController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $faculties = $em->getRepository('FacultyBundle:Faculty')->findFacultyWithDivision();
    ...
    {
        $faculty = new Faculty();
        $form = $this->createForm('FacultyBundle\Form\FacultyType', $faculty);
    ...
    {
        $deleteForm = $this->createDeleteForm($faculty);
        $editForm = $this->createForm('FacultyBundle\Form\FacultyType', $faculty);
     ...
     *
     * @Route("showfaculty", name="faculty_showfaculty")
     * @Method("GET")
     */
    public function showfacultyAction()
    {

        $em = $this->getDoctrine()->getManager();

        $faculties = $em->getRepository('FacultyBundle:Faculty')->findFacultyWithDivisionName(13);

        return $this->render('faculty/showfaculty.html.twig', array(
            'faculties' => $faculties,
        ));
    }
    /**
